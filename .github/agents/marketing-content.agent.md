...
**Describe roles and activities plainly**:
- ✅ "Martin worked with your CTO to identify where decisions stall" (not "facilitated executive alignment")
...
Ask: **Would a CFO or board member use this phrase?**
