...
**Case studies document real work. They should read like honest project reports, not success story marketing.**
...
Remember: Case studies prove Martin's value through honest documentation of real results, not through consulting buzzwords.
...
- **Related Agents**: `.github/agents/insights.agent.md`, `.github/agents/marketing-content.agent.md`
